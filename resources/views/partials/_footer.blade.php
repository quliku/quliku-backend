<footer class="text-center lg:text-left bg-white-primary text-black-primary">
    <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
        <div class="mr-12 hidden lg:block font-medium">
            <span>Terhubung dengan media sosial kami:</span>
        </div>
        <div class="flex justify-center">
            {{-- <a href="#!" class="mr-6 text-black-primary hover:text-orange-primary">
            ...
            {{-- <a href="#!" class="mr-6 text-black-primary">
            ...
            <a href="#!" class="mr-6 text-black-primary hover:text-orange-primary">
                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="whatsapp" class="w-3.5"
                    role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path fill="currentColor"
            ...
            <a href="#!" class="text-black-primary">
    ...
    <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
                <img src="/images/logo-with-text-vertikal.jpg" class="hidden md:block md:w-48" alt="logo Quliku" />
            </div>
            <div>
    ...
    <div class="text-center p-6 font-semibold">
        © 2022 Copyright: Quliku
    </div>
</footer>
